    ...
    <List className={classes.list + " " + classes.mlAuto}>
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          buttonIcon={Apps}
          dropdownList={[
            <Link to="/salesforce-ci-cd.html" className={classes.dropdownLink}>
              <LineStyle className={classes.dropdownIcons} /> CI/CD Implementation
            </Link>,
            <Link to="/salesforce-monitoring.html" className={classes.dropdownLink}>
              <Layers className={classes.dropdownIcons} />
              24/7 Monitoring
            </Link>,
            <Link to="/salesforce-tech-debt.html" className={classes.dropdownLink}>
              <Build className={classes.dropdownIcons} /> Tech Debt Reduction              
            </Link>
          ]}
        />
      </ListItem>
        ...
        <CustomDropdown
          ...
          dropdownList={[
            <Link
              ...
              onClick={e => smoothScroll(e, "logtracer")}
            >
              <Dns className={classes.dropdownIcons} /> LogTracer
            </Link>,
            <Link
        ...
        <CustomDropdown
          ...
          dropdownList={[
            <Link to="/about-us" className={classes.dropdownLink}>
              <AccountBalance className={classes.dropdownIcons} /> LogTracer
            </Link>,
            <Link to="/blog-post" className={classes.dropdownLink}>
              <ArtTrack className={classes.dropdownIcons} /> LogTracer
            </Link>,
      ...
      <ListItem className={classes.listItem}>
            <Link
              ...
              onClick={e => smoothScroll(e, "contacts")}
            >
              <Call className={classes.dropdownIcons} /> About Us
            </Link>
      </ListItem>
      <ListItem className={classes.listItem}>
        <Button
          ...
          round
        >
          <ShoppingCart className={classes.icons} /> logout
        </Button>
      </ListItem>
    </List>
  );
